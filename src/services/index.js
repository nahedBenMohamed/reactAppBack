module.exports.childService = require('./child.service');
module.exports.userService = require('./user.service');
module.exports.sharedService = require('./shared.service');
module.exports.diagnosticService = require('./diagnostic.service');
